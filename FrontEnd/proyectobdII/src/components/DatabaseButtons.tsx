...
import { Button, Card, Heading, List } from "@chakra-ui/react";
import { BiLogoPostgresql } from "react-icons/bi";
import { SiMysql, SiMicrosoftsqlserver } from "react-icons/si"; // Importa el logo de SQL Server
  ...
  return (
    <Card padding={4} boxShadow="md" backgroundColor="gray.700" borderRadius={10} maxWidth={300} minHeight={730}>
      ...
      <List alignContent="center">
        ...
        <Button leftIcon={<SiMicrosoftsqlserver color="red" />} onClick={() => onOpen("sqlserver")} width="100%" mt={4}>
          SQL Server
        </Button>
      </List>
    </Card>
